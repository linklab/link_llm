...
spec = importlib.util.spec_from_file_location('v043', VERSION/'0.model/lm.py')
model = importlib.util.module_from_spec(spec)
spec.loader.exec_module(model)
corpus = model.module('v043_corpus_cli', ROOT/'data/pretrain/v0.4.1/corpus.py')
...
def main():
    ...
    for name, default in [('epochs',8), ('vocab-size',768), ('layers',6), ('heads',4),
                          ('ffn-hidden',384), ('embed',96), ('block-size',64),
