...
if __name__ == "__main__":
    ...
    #   조기 종료 시 검증 PPL 2.94 (카운트 기준선 v0.0.9 = 2.96 아래 ✅)
    m.EMBED = 256              # ★ 임베딩 차원 E. 이 데이터 규모에선 E 를 키울수록 좋아요.
                               #   루트 ablation_block_size.py 실측 — E=H=256 이 E=32·H=128 보다
                               #   검증 PPL 0.40 낮아요. v0.2.1~2.5 도 이 용량을 그대로 씁니다.
