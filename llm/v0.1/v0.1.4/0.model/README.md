...
**목표:** 문맥을 2토큰으로 맞춰 카운트(v0.0.9)와 **공정한 대결**을 만들기.
...
`2.test/test.py` 의 **검증 PPL 이 v0.0.9(2.65) 아래**면 "같은 문맥에서 신경망 승".
1토큰 신경망(v0.1.0~3, 4~6점대)보다 문맥이 넓어 **2.62** 까지 내려가고, 카운트(2.65)도 넘어서요 — **신경망 승** ✅
(격차 0.03 · 파라미터는 78배. 조기 종료가 **검증 PPL 최저 에폭**의 가중치를 저장해 준 덕입니다.)
