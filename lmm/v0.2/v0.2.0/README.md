...
| 모델 | 학습 PPL | 검증 PPL |
|---|---|---|
| v0.0.9 카운트 (앞 2토큰 + 백오프) | 2.79 | 34.39 |
| v0.1.5 one-hot 2토큰 신경망 | 3.82 | **31.98** |
| **v0.2.0 임베딩 2토큰 신경망** | 3.40 | **33.39** |

- 카운트 기준선(34.39)은 **넘었어요** ✅
- 하지만 **one-hot(v0.1.5)은 아직 못 이겨요.** 학습 문장이 282개뿐이라, "비슷한 토큰끼리
  벡터를 공유해 아낀다"는 임베딩의 장점보다 토큰마다 독립된 칸을 갖는 one-hot 의
  **구별력**이 아직 더 크거든요.
