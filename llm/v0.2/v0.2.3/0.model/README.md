...
| dropout | 3.5614 | 364,105 | +0.034 |
| tying | 3.6355 | **207,305** | +0.108 |
| cosine | 3.4705 | 364,105 | −0.057 |
| all | 3.6513 | **207,305** | +0.123 |

- 가장 큰 도구 효과가 **0.12** 인데, **같은 설정의 실행 간 편차가 0.40** 이에요(3.26~3.66).
...
- 잡음과 무관한 유일한 사실: **weight tying 은 파라미터를 43% 줄인다**(364,105 → 207,305).
