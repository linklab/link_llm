...
spec = importlib.util.spec_from_file_location('v045', VERSION/'0.model/lm.py')
model = importlib.util.module_from_spec(spec)
spec.loader.exec_module(model)
corpus = model.module('v045_corpus_cli', ROOT/'data/pretrain/v0.4.1/corpus.py')
...
def main():
    ...
    for name, default in [('epochs',4), ('vocab-size',768), ('layers',4), ('heads',4),
                          ('ffn-hidden',256), ('embed',64), ('block-size',64),
    ...
    parser.add_argument('--variant', choices=['baseline','rope','rmsnorm','swiglu','gqa'], default='baseline')
    ...
    lm.TIE_WEIGHTS = not args.untied
