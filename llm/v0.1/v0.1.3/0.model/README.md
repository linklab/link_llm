...
**목표:** 손실을 더 낮추는 게 아니라 **일반화(검증 PPL) 개선**.

지금 산문 데이터는 쉬워서 격차가 작아요 — v0.0.9 에서 **학습 PPL 2.30 vs 검증 PPL 2.65**.
...
- 저장 형식은 v0.1.0~ 과 **동일** (`model.pt` state_dict + `vocab.json`). 웹앱/평가가 그대로 로드.
