...
spec = importlib.util.spec_from_file_location('v041', VERSION/'0.model/lm.py')
model = importlib.util.module_from_spec(spec)
spec.loader.exec_module(model)
corpus = model.module('v041_corpus_cli', ROOT/'data/pretrain/v0.4.1/corpus.py')
...
def main():
    ...
    for name, default in [('epochs',30), ('vocab-size',768), ('layers',4), ('heads',4),
                          ('ffn-hidden',256), ('embed',64), ('block-size',32),
                          ('batch-size',128), ('patience',5), ('seed',1234), ('threads',4)]:
    ...
    report = {'version': lm.MODEL_VERSION,
              ...
              'checkpoint': 'inference only; optimizer/scheduler/RNG resume is v0.4.2'}
