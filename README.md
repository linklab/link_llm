...
### v0.1.x — 신경망 언어모델 (임베딩 없음, 5단계 · 전부 웹앱 완결)
...
| **v0.1.3** | 정규화·초기화 | weight decay·초기화·수치안정 → 검증 PPL 개선 |
| **v0.1.4** | **기준선 대결 (캡스톤)** | 웹앱에서 v0.0.9(카운트) vs 신경망 bigram 을 PPL로 나란히 — "신경망이 정말 이겼나" |
...
> **비교 캡스톤**(v0.1.4·v0.2.6)으로 남겼어요 — 여러 모델을 웹앱에서 나란히 벤치마크하는 버전이에요.
